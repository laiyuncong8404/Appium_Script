...
require 'appium_lib'
require 'net/http'
require File.join(File.dirname(__FILE__), 'reliability_public_method')

APP_PATH = '../../jingdong238_iceboxcontrol/IceBoxControl_20150724_debug.apk'
...
def desired_caps
	{
		caps: {
			...
			resetKeyboard:    'true',
			noReset:          'false',
			log:              'E:/Appium_Script/Appium/appium.log', 
...
describe 'iceboxcontrol_AP_mode' do
	...
	context 'reliability for fridge of AP mode' do
		before :all do
		...
		it 'login with the work mode is STA' do
		 ...
		 @total_num.times do
			begin
				...
				# close_app
				# @driver.set_network_connection(4) #(ConnectionType:Data only)
				set_wait 20
				# launch_app
